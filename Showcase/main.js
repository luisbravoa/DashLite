function start() {
   ...
   var dashboard1 = new DashLite({
        ...
        items: [
                [
                {title: 'Youtube Video', content: '<iframe width="100%" src="https://www.youtube.com/embed/bMV-Wd5aIIM" frameborder="0" allowfullscreen></iframe>'},
                    {title: 'Title!', content: text1+text2+text3},

                ],

                [
                {title: 'Title!', content: text1+text2},
                {title: 'Youtube Video', content: '<iframe width="100%" src="https://www.youtube.com/embed/w0dXXNXOVSg" frameborder="0" allowfullscreen></iframe>'},
                {title: 'Title!', content: text3},
                {title: 'Title!', content: text3+text1}
                ],

                [
                {title: 'Title!', content: text1},
                {title: 'Title!', content: text1}
                ],
